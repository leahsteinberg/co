...
Elm.ConvertJson.make = function (_elm) {
   ...
   var encodeWUpdate = function (wUp) {
      return function () {
         ...
         {case "Caret":
            return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                     ,_0: "type"
                                                     ,_1: $Json$Encode.string("Caret")}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: "pos"
                                                     ,_1: $Json$Encode.$int(wUp._0)}]));
            case "Delete":
            return $Json$Encode.object(A2($List._op["::"],
              {ctor: "_Tuple2"
              ,_0: "type"
   ...
   var toChar = function (str) {
      return function () {
         var _v12 = $List.head($String.toList(str));
         switch (_v12.ctor)
   ...
   str) {
      ...
      "Insert") ? function () {
         var _v14 = A2($Json$Decode.decodeString,
         tInsertDecoder,
         str);
         switch (_v14.ctor)
         {case "Err":
            return $Model.NoTUpdate;
            case "Ok": return _v14._0;}
         _U.badCase($moduleName,
      ...
      "DeleteString") ? function () {
         ...
         {case "Err":
            return $Model.NoTUpdate;
            case "Ok": return _v23._0;}
         _U.badCase($moduleName,
         "between lines 55 and 57");
      }() : _U.badIf($moduleName,
      "between lines 41 and 57");
   });
   ...
   var decodeWInsert = function (str) {
      return function () {
         var _v26 = A2($Json$Decode.decodeString,
         wCharDecoder,
         str);
         switch (_v26.ctor)
         {case "Err":
   ...
   var jsonToTUpdate = function (str) {
      return function () {
         var _v32 = A2($Json$Decode.decodeString,
         A2($Json$Decode._op[":="],
         "type",
         $Json$Decode.string),
         str);
   ...
   var jsonToWUpdate = function (str) {
      return function () {
         var _v35 = A2($Json$Decode.decodeString,
         A2($Json$Decode._op[":="],
         "type",
         $Json$Decode.string),
         str);
         ...
         return function () {
            ...
            {case "Delete":
               return A2($Woot.canIntegrate,
                 wUpd,
                 model.wSeen) ? A2($Graph.integrateRemoteDelete,
                 wUpd._0,
                 model) : poolUpdate;
               case "Insert":
               return A2($Woot.canIntegrate,
                 wUpd,
                 model.wSeen) ? A2($Graph.integrateRemoteInsert,
                 wUpd._0,
                 model) : poolUpdate;
               case "SiteId":
               return {ctor: "_Tuple2"
      ...
      return function () {
         ...
         return function () {
            ...
            {case "Delete":
               return A2($Woot.canIntegrate,
                 wUpd,
                 m.wSeen) ? A2($Graph.integrateRemoteDelete,
                 wUpd._0,
                 m) : A2(moveToProcessed,wUpd,m);
               case "Insert":
               return A2($Woot.canIntegrate,
                 wUpd,
                 m.wSeen) ? A2($Graph.integrateRemoteInsert,
                 wUpd._0,
...
Elm.TUpdate.make = function (_elm) {
   ...
   F2(function (e,_v7) {
      return function () {
         switch (_v7.ctor)
         {case "_Tuple2":
            return A2($Editor.processEdit,
              e,
              _v7._0);}
         _U.badCase($moduleName,
         "on line 155, column 40 to 55");
      }();
   }),
   {ctor: "_Tuple2"
   ...
   function (_v11) {
      return function () {
         switch (_v11.ctor)
         {case "_Tuple2":
            return $ConvertJson.stringUpdateToJson(_v11._0.doc.str);}
         _U.badCase($moduleName,
         "on line 139, column 44 to 74");
      }();
   },
   modelFold);
   ...
   var docUpdatesToSend = A3($Signal.filter,
   throwOutNoTUpdates,
   $Model.NoTUpdate,
   A2($Signal._op["<~"],
   editToTUpdate,
