...
Elm.Woot.make = function (_elm) {
   ...
   var subSeq = F3(function (wStr,start,end) {
      subSeq: while (true) {
         var _p16 = wStr;
         if (_p16.ctor === "[]") {
               return _U.crashCase("Woot",{start: {line: 41,column: 5},end: {line: 45,column: 45}},_p16)("oh no");
            } else {
               var _p18 = _p16._1;
               if (_U.eq(_p16._0.id,start.id)) return A2(subSeqGrab,_p18,end); else {
                     var _v18 = _p18,_v19 = start,_v20 = end;
                     wStr = _v18;
                     start = _v19;
                     end = _v20;
                     continue subSeq;
   ...
   var wToString = function (wStr) {
      wToString: while (true) {
         ...
         if (_p19.ctor === "[]") {
               ...
               var _p21 = _p19._1;
               var _p20 = _p19._0;
               if (_U.cmp(_p20.vis,0) > 0) return A2($String.cons,_p20.ch,wToString(_p21)); else {
                     var _v22 = _p21;
                     wStr = _v22;
                     continue wToString;
                  }
   ...
   var wIdOrder = F2(function (wA,wB) {
      ...
      var wASite = _p23._0;
      var wAClock = _p23._1;
      return _U.cmp(wASite,wBSite) > 0 ? $Basics.GT : _U.cmp(wASite,wBSite) < 0 ? $Basics.LT : _U.cmp(wAClock,wBClock) > 0 ? $Basics.GT : $Basics.LT;
   });
...
Elm.Graph.make = function (_elm) {
   ...
   var findLaterWChar = F2(function (insCh,wStr) {
      findLaterWChar: while (true) {
         var _p0 = wStr;
         if (_p0.ctor === "[]") {
               return _U.crashCase("Graph",{start: {line: 160,column: 5},end: {line: 174,column: 43}},_p0)("empty list");
            } else {
               if (_p0._1.ctor === "[]") {
                     return _U.crashCase("Graph",{start: {line: 160,column: 5},end: {line: 174,column: 43}},_p0)("one element in list");
                  } else {
                     if (_p0._1._1.ctor === "[]") {
                           var _p4 = _p0._1._0;
                           var _p3 = _p0._0;
                           return A2($Woot.isLaterWChar,_p3,insCh) ? {ctor: "_Tuple2",_0: $Constants.startChar,_1: _p3} : A2($Woot.isLaterWChar,
                           _p4,
                           insCh) ? {ctor: "_Tuple2",_0: _p3,_1: _p4} : {ctor: "_Tuple2",_0: _p3,_1: _p4};
                        } else {
                           var _p5 = _p0._1._0;
                           if (A2($Woot.isLaterWChar,_p5,insCh)) return {ctor: "_Tuple2",_0: _p0._0,_1: _p5}; else {
                                 var _v1 = insCh,_v2 = A2($List._op["::"],_p5,_p0._1._1);
                                 insCh = _v1;
                                 wStr = _v2;
   ...
   var insertIntoList = F3(function (wCh,wStr,pos) {
      ...
      if (_p6.ctor === "::") {
            var _p8 = _p6._1;
            var _p7 = _p6._0;
            return _U.eq(pos,0) ? A2($List._op["::"],wCh,A2($List._op["::"],_p7,_p8)) : A2($List._op["::"],_p7,A3(insertIntoList,wCh,_p8,pos - 1));
         } else {
            return _U.list([wCh]);
         }
   });
   ...
   var integrateInsert$ = F5(function (wCh,pred,succ,posi,model) {
      integrateInsert$: while (true) {
         var subStr = A3($Woot.subSeq,A2($List._op["::"],$Constants.startChar,A2($Basics._op["++"],model.wString,_U.list([$Constants.endChar]))),pred,succ);
         var idOrderSubStr = A2($List._op["::"],pred,A2($Basics._op["++"],withoutPrecedenceOrdered(subStr),_U.list([succ])));
         var _p9 = A2(findLaterWChar,wCh,idOrderSubStr);
         var newPred = _p9._0;
         var newSucc = _p9._1;
         var _p10 = subStr;
         if (_p10.ctor === "[]") {
               ...
               "     subStr - ",
               A2($Basics._op["++"],
               $Basics.toString(subStr),
               A2($Basics._op["++"],
               "     newPred - ",
               A2($Basics._op["++"],$Basics.toString(newPred),A2($Basics._op["++"],"     new Succ  - ",$Basics.toString(newSucc)))))))))))))))))});
               return _U.eq(wCh.ch,_U.chr("l")) ? debugModel : newModel;
            } else {
               var debugModel = _U.update(model,
               {debug: A2($Basics._op["++"],
               model.debug,
               A2($Basics._op["++"],
               "integrating WITH STUFF ",
               A2($Basics._op["++"],
               $Basics.toString(wCh.ch),
               A2($Basics._op["++"],
               "      site",
               ...
               "      id ordered ",
               A2($Basics._op["++"],
               $Basics.toString(idOrderSubStr),
               A2($Basics._op["++"],
               "      newPred - ",
               A2($Basics._op["++"],$Basics.toString(newPred),A2($Basics._op["++"],"      new Succ  - ",$Basics.toString(newSucc)))))))))))))))))});
               if (_U.eq(wCh.ch,_U.chr("l"))) {
                     var _v5 = wCh,_v6 = newPred,_v7 = newSucc,_v8 = posi,_v9 = debugModel;
                     wCh = _v5;
                     pred = _v6;
                     succ = _v7;
                     posi = _v8;
                     model = _v9;
                     continue integrateInsert$;
                  } else {
                     var _v10 = wCh,_v11 = newPred,_v12 = newSucc,_v13 = posi,_v14 = model;
                     wCh = _v10;
                     pred = _v11;
                     succ = _v12;
                     posi = _v13;
   ...
   var generateInsChar = F4(function ($char,predIndex,nextIndex,model) {
      ...
      return {ctor: "_Tuple2",_0: A5(integrateInsert$,newWChar,pred,succ,nextIndex,newModel),_1: $Model.W($Model.Insert(newWChar))};
   });
   var integrateRemoteInsert = F2(function (wChar,model) {
      ...
      var insertPos = A2($Woot.pos,model.wString,next);
      var newCP = _U.cmp(currCP,insertPos) > 0 ? currCP + 1 : currCP;
      var newCPModel = _U.update(model,{doc: A2(updateCP,model.doc,newCP)});
      ...
      "integrating: ",
      A2($Basics._op["++"],
      $Basics.toString(wChar),
      A2($Basics._op["++"],
      "site is: ",
      A2($Basics._op["++"],
      $Basics.toString(model.site),
      A2($Basics._op["++"],"next is",A2($Basics._op["++"],$Basics.toString(next.ch),A2($Basics._op["++"],"prev is ",$Basics.toString(prev.ch)))))))))});
      return _U.eq(wChar.ch,_U.chr("l")) ? {ctor: "_Tuple2"
                                           ,_0: debugModel
                                           ,_1: $Model.T(A3($Model.I,wChar.ch,insertPos,$Basics.fst(wChar.id)))} : {ctor: "_Tuple2"
                                                                                                                   ,_0: newModel
                                                                                                                   ,_1: $Model.T(A3($Model.I,
                                                                                                                   wChar.ch,
                                                                                                                   insertPos,
                                                                                                                   $Basics.fst(wChar.id)))};
   });
...
Elm.Editor.make = function (_elm) {
   ...
   var processServerUpdate = F2(function (wUpd,model) {
      ...
      {case "SiteId": return {ctor: "_Tuple2",_0: _U.update(model,{site: _p17._0}),_1: _U.list([])};
         ...
         case "CurrWString": var _p18 = A2(processTUpdate,A2($Model.IS,_p17._1,0),model);
           var newM = _p18._0;
           var newW = _p18._1;
           return {ctor: "_Tuple2",_0: _U.update(newM,{debug: $Basics.toString(newM)}),_1: newW};
         default: return {ctor: "_Tuple2",_0: model,_1: _U.list([])};}
   });
   var processEdit = F2(function (edit,model) {
      var _p19 = edit;
      if (_p19.ctor === "T") {
            return A2(processTUpdate,_p19._0,model);
         } else {
            return A2(processServerUpdate,_p19._0,model);
         }
   });
   var processEditsAccum = F3(function (edits,model,oldEdits) {
      processEditsAccum: while (true) {
         ...
         if (_p20.ctor === "[]") {
               ...
               var _p21 = A2(processEdit,_p20._0,model);
               var newModel = _p21._0;
               var accEdits = _p21._1;
               var _v10 = _p20._1,_v11 = newModel,_v12 = A2($Basics._op["++"],oldEdits,accEdits);
               edits = _v10;
               model = _v11;
               oldEdits = _v12;
...
Elm.TUpdate.make = function (_elm) {
   ...
   F2(function (e,_p0) {    var _p1 = _p0;return A2($Editor.processEdits,e,_p1._0);}),
   {ctor: "_Tuple2",_0: $Constants.emptyModel,_1: _U.list([])},
   edits);
   var sendNewString = A2($Signal.map,function (_p2) {    var _p3 = _p2;return $ConvertJson.stringUpdateToJson(_p3._0.doc.str);},modelFold);
   ...
   var main = A2($Signal.map,function (_p4) {    var _p5 = _p4;return $Graphics$Element.show(_p5._0);},modelFold);
